...
@push('styles')
    ...
    .secure-icons i:nth-child(1) { top: 10%; left: 15%; }
    .secure-icons i:nth-child(2) { top: 20%; right: 20%; }
    .secure-icons i:nth-child(3) { bottom: 15%; left: 30%; }
    </style>
    <style>
    .cta-btn {
...
<div class="container">
    ...
    <section class="hero text-center py-5 position-relative overflow-hidden">
        ...
        <h1 class="fw-bold hero-title">Lebih dari Sekedar Link.</h1>
    ...
    @else
        <div class="text-center my-4 cta-register mt-5">
            <p class="text-muted mb-0 cta-text">
                Daftar gratis dan nikmati fitur lengkap cuma.click
            </p>
            <a href="{{ route('register') }}"
            class="btn btn-primary btn-sm px-5 shadow-sm mt-2 cta-btn">
